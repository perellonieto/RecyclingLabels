...
# In this dataset the best lr parameter is 0.0
...
unique_file = 'Example_10_{}_a{}_r{:03.0f}_{}'.format(dataset_name, alpha*100, random_state,
...
files_list = glob.glob("./Example_10*summary.csv")
