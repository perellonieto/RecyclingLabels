...
method=${parameters_all[$PBS_ARRAYID]}[method]
method=${!method}
dataset=${parameters_all[$PBS_ARRAYID]}[dataset]
dataset=${!dataset}
epochs=${parameters_all[$PBS_ARRAYID]}[epochs]
epochs=${!epochs}
echo ${method} ${dataset} ${epochs}
architecture='lr' # lr, mlp100m, mlp100sdm, mlp100ds100dm

path_results='results_2018_01_16_sgd'
verbose=1
